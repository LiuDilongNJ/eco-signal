...
export interface DataPageLayoutProps {
    ...
    /** Default sort field used on first load and Reset */
    defaultSortKey?: string | null
    /** Default sort direction used on first load and Reset */
                ...
                <TableToolbar className="data-toolbar">
                    ...
                    <div className="data-toolbar-right">
                        <div className="data-action-group">
                            <ESButton appearance="unstyled" type="button" className="data-btn" title="Reset" onClick={() => { setColumnFilters({}); setSearchQuery(""); setSortKey(defaultSortKey); setSortDir(defaultSortDir); setSelectedRows(new Set()); setCurrentPage(1) }}>
