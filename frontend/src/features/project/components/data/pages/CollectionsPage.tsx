...
const COLUMNS: ColumnDef[] = [
    ...
    { key: "project_url", label: "Ext. Project", type: "text", width: "200px", sortable: true, filterable: true },
    { key: "external_media_url", label: "Ext. Media", type: "text", width: "200px", sortable: true, filterable: true },
