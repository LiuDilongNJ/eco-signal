...
export const IMPORT_RESOURCE_CONFIGS = {
    ...
    annotations: {
        ...
        fields: [
            ...
            field("reference", "optional boolean, default false", "Reference annotation"), field("comments", "optional", "Annotation comments"),
    ...
    audioAnnotations: {
        subject: "Audio annotation",
        templateFileName: "audio_annotations_template.csv",
        template: "media_id,min_x,max_x,min_y,max_y,sound_id,reference,comments,taxon_id,uncertain,sound_distance_m,distance_not_estimable,individual_num,creator_type,confidence,animal_sound_type\n101,1.5,3.2,1000,5000,1,false,Bird call,,false,20,false,1,user,,song\n102,4,6,800,3000,1,false,Second bird call,,false,15,false,1,user,,call\n",
        example: { media_id: 101, min_x: 1.5, max_x: 3.2, min_y: 1000, max_y: 5000, sound_id: 1, reference: false, comments: "Bird call", taxon_id: null, uncertain: false, sound_distance_m: 20, distance_not_estimable: false, individual_num: 1, creator_type: "user", confidence: null, animal_sound_type: "song" },
        additionalExample: { media_id: 102, min_x: 4, max_x: 6, min_y: 800, max_y: 3000, sound_id: 1, reference: false, comments: "Second bird call", taxon_id: null, uncertain: false, sound_distance_m: 15, distance_not_estimable: false, individual_num: 1, creator_type: "user", confidence: null, animal_sound_type: "call" },
        fields: [
            field("media_id", "required positive integer", "Audio media in the selected collection"),
            field("min_x", "required number", "Start time in seconds"), field("max_x", "required number", "End time in seconds"),
            field("min_y", "required number", "Minimum frequency in Hz"), field("max_y", "required number", "Maximum frequency in Hz"),
            field("sound_id", "required positive integer", "Sound classification identifier"),
            field("reference", "optional boolean, default false", "Reference annotation"), field("comments", "optional", "Annotation comments"),
            field("taxon_id", "optional integer", "Taxon identifier"), field("uncertain", "optional boolean", "Uncertainty flag"),
            field("sound_distance_m", "optional integer", "Estimated distance in metres"), field("distance_not_estimable", "optional boolean", "Distance cannot be estimated"),
            field("individual_num", "optional integer, minimum 1", "Number of individuals"), field("creator_type", "optional, default user", "Creator category"),
    ...
    photoAnnotations: {
        subject: "Photo annotation",
        templateFileName: "photo_annotations_template.csv",
        template: "media_id,min_x,max_x,min_y,max_y,object_type,taxon_id,uncertain,individual_num,reference,comments,creator_type\n201,120,460,80,390,organism,,false,1,false,Heron on shore,user\n202,24,180,35,210,other,,,,false,Camera housing,user\n",
        example: { media_id: 201, min_x: 120, max_x: 460, min_y: 80, max_y: 390, object_type: "organism", taxon_id: null, uncertain: false, individual_num: 1, reference: false, comments: "Heron on shore", creator_type: "user" },
        additionalExample: { media_id: 202, min_x: 24, max_x: 180, min_y: 35, max_y: 210, object_type: "other", taxon_id: null, uncertain: null, individual_num: null, reference: false, comments: "Camera housing", creator_type: "user" },
        fields: [
            field("media_id", "required positive integer", "Photo media in the selected collection"),
            field("min_x", "required number", "Left boundary in original-image pixels"), field("max_x", "required number", "Right boundary in original-image pixels"),
            field("min_y", "required number", "Top boundary in original-image pixels"), field("max_y", "required number", "Bottom boundary in original-image pixels"),
            field("object_type", "required: organism or other", "Annotated object type"),
            field("taxon_id", "optional; organism only", "Taxon identifier"), field("uncertain", "optional; organism only", "Uncertainty flag"),
            field("individual_num", "optional integer, minimum 1; organism only", "Number of individuals"),
            field("reference", "optional boolean, default false", "Reference annotation"), field("comments", "optional", "Annotation comments"),
            field("creator_type", "optional, default user", "Creator category"),
        ],
    },
    reviews: {
        subject: "Review",
    ...
    tasks: {
        ...
        template: "media_id,type,annotation_id,assignee_id,comment\n101,media,,7,Review this media\n102,media,,8,Review this media too\n",
        example: { media_id: 101, type: "media", annotation_id: null, assignee_id: 7, comment: "Review this media" },
        additionalExample: { media_id: 102, type: "media", annotation_id: null, assignee_id: 8, comment: "Review this media too" },
