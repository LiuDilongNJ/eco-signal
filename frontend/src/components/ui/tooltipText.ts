const ACTION_TOOLTIP_TEXT: Record<string, string> = {
    ...
    "Reset table": "Clear search, filters, sorting, selected rows, and reload the table",
    ...
    "Reset table filters and reload list": "Clear annotation filters, sorting, selected rows, and reload the list",
