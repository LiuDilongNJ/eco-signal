...
AUTHORIZATION_POLICIES: dict[AuthorizationAction, AuthorizationPolicy] = {
    ...
    AuthorizationAction.MEDIA_EDIT: AuthorizationPolicy("audio", "write"),
    AuthorizationAction.MEDIA_DELETE: AuthorizationPolicy("audio", "write"),
    AuthorizationAction.MEDIA_LINK: AuthorizationPolicy("audio", "write"),
    AuthorizationAction.MEDIA_ASSIGN: AuthorizationPolicy("collection", "write"),
    AuthorizationAction.MEDIA_RUN_AI_MODELS: AuthorizationPolicy("audio", "read", allow_uploader=True),
